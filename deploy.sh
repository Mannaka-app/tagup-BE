...
scp -i /Users/donghyun/Downloads/back.pem -r dist/ prisma/ package.json package-lock.json tsconfig.build.json nest-cli.json ubuntu@ec2-3-34-44-18.ap-northeast-2.compute.amazonaws.com:~/tagup-BE/
